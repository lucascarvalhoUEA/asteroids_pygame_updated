<div align="center">
  ...
  <p>Uma versão atualizada com novas mecânicas do jogo Asteroids feito em Pygame.</p>
</div>

---

## 📖 Sobre o Projeto
Neste projeto, **Asteroids Atualizado**, criamos um ritmo um pouco mais acelerado e mecânicas novas para deixar o jogo mais divertido e te forçar a tomar decisões mais rápidas o tempo todo.

## Uso de IA no Desenvolvimento
Este projeto utilizou ferramentas de IA como apoio ao desenvolvimento, principalmente para:

- revisar código e sugerir melhorias;
- acelerar tarefas repetitivas de implementação.
- apoiar a documentação e organização do projeto;
...
| Lucas Lima Carioca | 2315310013 |

## ✨ Novas Mecânicas no Jogo
...
| **Seta Para Cima** | Liga as turbinas de foguete e acelera a nave pra frente. |
| **Barra de Espaço** | Atira tiros para onde a nave apontar. |
| **Shift Esquerdo** | **O Dash:** Use a arrancada para se desviar dos perigos. |
| **Botão ESC** | Encerra o jogo instantanemamente. |
